...
2. **実行系分岐**:
   ...
   - `model` が `composer*` または `cursor-*`: `bash .claude/skills/delegate-chore/scripts/delegate-cursor.sh "$model" chore "$request_file" "$response_file"`
