...
| 実行系           | モデル名                                                                                                                                                                                                                                                                                                                                                                        | 補足                                                                                                                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Claude CLI       | `fable`, `opus`, `sonnet`, `haiku`, `claude-fable-5-1`, `claude-fable-5`, `claude-opus-5`, `claude-opus-5[1m]`, `claude-opus-4-8`, `claude-opus-4-8[1m]`, `claude-sonnet-5`, `claude-sonnet-5[1m]`, `claude-sonnet-4-6`, `claude-haiku-4-5`                                                                                                                                     | Claude 系モデルの alias に加え、バージョン固定用にフル `claude-*` モデル ID も指定可（`[1m]` は 1M context 変種）                                                                                          |
| Codex CLI        | `gpt-6-astra`, `gpt-5.6`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `gpt-5`, `gpt-5.5`, `gpt-5.4`, `gpt-5.4-mini`, `gpt-5.4-nano`, `gpt-5.3-codex-spark`                                                                                                                                                                                                                  | `delegate-imagegen` は `gpt*` / Codex 分岐のみ受け付ける                                                                                                                                                   |
...
`gpt-6-astra` も上記の Codex effort suffix（`low`〜`ultra`）に対応する。Codex のローカルモデル一覧で確認済み。`gpt-6-astra` と `gpt-5.6-sol` の catalog 既定値は `low` だが、suffix を省略した場合の実効値は実行先 CLI の設定と既定値に依存する。
