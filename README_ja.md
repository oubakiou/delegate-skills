...
| opencode CLI     | `opencode/opencode-go/glm-5.2`, `opencode/opencode/muse-spark-1.3-contributor-free`                                                                                                                                                                                                                                                  | 記法は `opencode/<provider>/<model>`（provider の省略不可）。実機往復を確認したモデル。他は `opencode models` の出力から選ぶ |
