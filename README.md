...
| Devin CLI        | `swe-1.7`, `swe-1.7-lightning`, `swe-1.6`, `swe-1.6-fast`, `devin-glm-5.2`, `devin-deepseek-v4-pro`, `devin-nemotron-3-ultra`, `devin-kimi-k3`, `devin-gemini-3.8-flash`                                                                                                                                                             | `devin-*` strips the prefix before passing the model to Devin CLI                                                                                                                           |
