...
| opencode CLI     | `opencode/opencode-go/glm-5.2`, `opencode/opencode/muse-spark-1.3-contributor-free`                                                                                                                                                                                                                                                  | Notation is `opencode/<provider>/<model>` (provider required). Round-trip verified; pick others from `opencode models` |
